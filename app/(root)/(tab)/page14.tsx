  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titleHead}>
        <Text style={styles.tit}>Lesson 14: THE SIGNIFICANCE OF MATERIALS USED ON PALM

        </Text>
        <Text style={styles.tit}>Text: Matthew 21: 6-11.</Text>
        <Text style={styles.tit}>Aim: That we may learn to use our possessions to praise and
          honour Jesus.
