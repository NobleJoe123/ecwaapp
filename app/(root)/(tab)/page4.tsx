  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titleHead}>
        <Text style={styles.tit}>Lesson 4: REVIEW OF LESSONS 1 -3 THE NEW BIRTH PROCESS (Part 1)</Text>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <Text style={styles.subtitle}>THE SPIRITUAL BIRTH</Text>
        <Text style={styles.content}>
          <Text>The Lord Jesus said, "Truly, truly I say to you, unless one is born-again,
            he cannot see the Kingdom of God" When Nicodemus asserted the physical impossibility for an adult to be born the second time,
            Jesus explained that the rebirth He was talking about is a spiritual experience (vs. 5, 6). Jesus then stated the two agents through which the spiritual rebirth must be effected.
            He said, "Unless one is born of WATER and The SPIRIT, he cannot enter into the Kingdom of God" (v. 5).

          </Text>
        </Text>
        <Text style={styles.subtitle}>A. BEING BORN OF WATER</Text>
        <Text style={styles.content}>
          1. <Text>SIGNIFICANCE OF "WATER"
            a.  WATER signifies the need for cleansing  from sin, and being sanctified for God (See Matthew 3:6 -8; Mark 1: 4, 5).

          </Text>
        </Text>
        <Text style={styles.content}>
          2. <Text>If anyone professes to be a follower of Jesus Christ, and does not allow Jesus to apply this WATER to wash him clean from sin, such a person does not really belong to Jesus (John 13:8).
          </Text>
        </Text>
        <Text style={styles.content}>
          3. <Text>The washing with the WATER signifies that those who are so washed have repented of their sin (Matthew 3: 4 -6, 11a). That was what the baptism by John the Baptist signified. That also explains why John condemned unrepentant Pharisees and Sadducees who approached him for baptism (Matthew 3:7-10).</Text>
        </Text>
        <Text style={styles.content}>
        ...
        <Text style={styles.content}>
          5. <Text>The Water also represents the Word of God, the Bible (John 15:3; 17: 17; Ephesians 5: 25, 26).
        ...
        <Text style={styles.subtitle}>SUMMARY ON "WATER":     </Text>
        <Text style={styles.content}>

          <Text>For a sinner to be born-again,
        ...
        <Text style={styles.subtitle}>
          <Text style={styles.content}>
            ii. <Text>Having been convicted of his sin, he must repent, forsake his sins and turn to God for mercy and pardon.
              These done, he has been "BORN OF WATER." This is the first stage in the process of being born-again. Note that in the process of being born-again. being BORN
        ...
        <Text style={styles.subtitle}>B.  BEING BORN OF THE SPIRIT (John 3:5) </Text>
        <Text style={styles.content}>
          <Text>WATER comes first. That is, the word of God
        ...
        <Text style={styles.content}>
          2. <Text>At the point when the sinner gets BORN OF THE SPIRIT, he experiences what ought to be properly understood as BAPTISM OF THE HOLY SPIRIT (1 Corinthians 12: 13, 18). This is a one-
        ...
        <Text style={styles.content}>
          4. <Text>By this singular exercise, i.e. BAPTISM OF THE HOLY SPIRIT, the new believer becomes:
          </Text>

        </Text>
        <Text style={styles.content}>
          a. <Text>born-again (John 3: 5).
          </Text>
        ...
        <Text style={styles.content}>
          c. <Text>ajoint heir with Jesus Christ (Romans 8: 17).</Text>

        </Text>
        <Text style={styles.content}>
          d. <Text> one whose name is written in the Book of Life (Luke 10:20; Revelation 20: 15).
          </Text>

        </Text>
        <Text style={styles.content}>e. sealed with the Holy Spirit (Ephesians 1: 13; 4:30).
        </Text>
        <Text style={styles.content}>
          f. <Text>seated with Christ in the Heavenly places, far above principalities and powers (Ephesians 1: 20, 21; 2:6).
          </Text>
        </Text>
        <Text style={styles.content}>
